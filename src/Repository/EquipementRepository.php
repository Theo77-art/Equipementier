...
class EquipementRepository extends ServiceEntityRepository
{
    ...
    */
    ...
    //Methode affichage equipement par Nom et Quantité

    /**
     * @return Equipement[]
     */

    public function ShowByNameAndQuantity(): array
    {
        $entityManager = $this->getEntityManager();

        $query = $entityManager->createQuery(

            'SELECT e.nom, e.quantite
    ...
    public function tailleTableau(): int
    {
        $query = $em->createQuery('SELECT COUNT(DISTINCT e.nom) FROM App\Entity\Equipement');
